...
final class MultiSelectView: UIView {
    ...
    private lazy var label: CustomLabel = {
        let title = CustomLabel(text: "Çalışma saatlerini seçerek ayarlayabilirsin!", fontSize: 14, fontType: .medium, textColor: AppColors.customWhite)
    ...
    private func updateAppearance() {
        backgroundColor = isSelected ? AppColors.customBlue : AppColors.customLightGray
