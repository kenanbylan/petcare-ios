...
final class ManageNotificationViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        let emailLabel = CustomLabel(text: "Receive Emails", fontSize: 14, fontType: .medium, textColor: AppColors.labelColor)
        ...
        let pushNotificationLabel = CustomLabel(text: "Receive Push Notifications", fontSize: 14, fontType: .medium, textColor: AppColors.labelColor)
